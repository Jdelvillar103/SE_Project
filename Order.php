      ...
      {  
           ...
           {  
                ...
                {  
                    ...
                    $item_array['item_quantity']--;
                    if($item_array['item_quantity']==0)
                    {
...
<html>
    ...
    <body>
                        ...
                        <p class="md-3 header-links">
                            ...
                            <?php
                                if(isset($_SESSION['ID']))//If logged in, display login button
                                {
                                    ...
                                    //echo '<script>alert("Must Log In to checkout")</script>';
                            ?>
        ...
        <div class="container" style="width:700px;">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-dark">
                        ...
                        <tr>
                            ...
                            <td align="center"><a href="Order.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span
                                    class="text-danger">[-]</span></a> <a href="Order.php?action=add&id=<?php echo $values["item_id"]; ?>"> <span
            ...
            <br>
            <div class="row">
                <div class="col-md-2 col-12"></div><!--Basically adds padding to the left side-->

                <div class="col-md-4 col-12"><!-- Delivery Verification Information -->
                    <?php
                    ...
                    <form  action="../api-address-single.php" method="post">
                        <div>
                        ...
                        <div>
                            <button type="submit" id="signin_button" name="submit"><span style="font-size:18px">Verify Address</span></button>
                    ...
                    <?php
                        ...
                        if (strpos($fullurl,"verify=success") == true){
